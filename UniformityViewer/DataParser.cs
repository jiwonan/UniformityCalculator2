...
namespace UniformityViewer
{
    ...
    {
        private MySqlConnection conn = new MySqlConnection("Server = 192.168.29.20; Port=3939; Database = letinar_uniform; Uid = user; Pwd = QqN3y29JrK1nPtlk#;Connection Timeout=15");
